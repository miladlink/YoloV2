...
def find_all_boxes (output, device, conf_thresh, num_classes, anchors, num_anchors, only_objectness = 1, validation = False):
...
def filtered_boxes (model, device, img, conf_thresh, nms_thresh):
    ...
    boxes = find_all_boxes (output, device, conf_thresh, model.num_classes, model.anchors, model.num_anchors) [0]
